# Copyright 2007-2011, BlueDynamics Alliance - http://bluedynamics.com
...
In Devilstick we have two simple structural elements and elements descriping 
...
class IDSAttribute(IDSStructural):
    """atomar data-entity
    """
    type = Attribute("data type of the attribute (string)") 
